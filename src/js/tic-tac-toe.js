document.addEventListener("DOMContentLoaded", () => {
  ...
  function tieGameLogic(currentGame){
    switch(true){
      case currentGame[0] !== currentGame[1] && currentGame[0] !== currentGame[2] &&
        currentGame[0] !== currentGame[3] && currentGame[0] !== currentGame[6] &&
        currentGame[0] !== currentGame[4] && currentGame[0] !== currentGame[8] &&
        currentGame[1] !== currentGame[4] && currentGame[1] !== currentGame[7] &&
        currentGame[2] !== currentGame[5] && currentGame[2] !== currentGame[8] &&
        currentGame[3] !== currentGame[4] && currentGame[3] !== currentGame[5] &&
        currentGame[6] !== currentGame[7] && currentGame[6] !== currentGame[8] &&
        currentGame[2] !== currentGame[4] && currentGame[2] !== currentGame[6]:
  ...
  for(let i = 0; i < cells.length; i++){
    cells[i].addEventListener("click", () => {
      ...
      winLogic(board);
      turnLogic();
      clickCounter >= 9 ? alert("Tie game! no winner."): console.log("Continue playing");      
    });
  } 
